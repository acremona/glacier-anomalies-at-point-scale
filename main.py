...
path_first_img = "C:\\Users\\User\\Desktop\\Eth\\MasterIII\\Project\\images_test\\2019-07-26_10-30.jpg"
...
if len(matches)>1:
    ...
    if not matches:
        print('No matches found in the first image. Try with another image.')
