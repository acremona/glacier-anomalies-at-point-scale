...
# setup initial location of window1
c, r, w, h = 430, 280, 80, 120  # simply hardcoded the values (column, row, width, heigth)
track_window = (c, r, w, h)
cv2.rectangle(first_img, (c,r), (c+w,r+h), 255,2)

# setup initial location of window2
c2, r2, w2, h2 = 430, 140, 80, 120  # simply hardcoded the values (column, row, width, heigth)
track_window2 = (c2, r2, w2, h2)
cv2.rectangle(first_img, (c2,r2), (c2+w2,r2+h2), 255, 2)
cv2.imshow("fisrt image", first_img)

# set up the ROI for tracking
roi = first_img[r:r + h, c:c + w]
roi2 = first_img[r2:r2 + h2, c2:c2 + w2]
...
mask2 = create_green_mask(hsv_roi2) + create_blue_mask(hsv_roi2)
